...
// import { Departmentt} from "./config";
...
import { AdminLogin, getUser, Login } from "@/app/controller/auth/auth";
import { toast } from "react-toastify";
import { useUserContext } from "@/contexts/users/userUser";
import { Admin, User, useUserPaylaod } from "@/contexts/types";
...
export default function SiginCar() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full rounded-md shadow-lg md:justify-between md:flex-row bg-gradient-to-br from-amber-50 dark:from-slate-900 via-blue-50 dark:via-slate-950 to-transparent">
